...
def create_table():
    ...
    yesterday_clockin_data = yesterday_clockin_data.rename(columns={'工作人数': '昨日工作人数'})
    yesterday_clockin_data = yesterday_clockin_data[['小组长','昨日工作人数']]
    ...
    lastweek_clockin_data = lastweek_clockin_data.rename(columns={'工作人数': '上周工作人数'})
    lastweek_clockin_data = lastweek_clockin_data[['小组长','上周工作人数']]
    m2_sheet = m2_sheet.merge(lastweek_clockin_data,how='left')

    thisweek_clockin_data = get_clockin_data(this_monday,today)
    thisweek_clockin_data = thisweek_clockin_data.rename(columns={'工作人数': '本周工作人数'})
    thisweek_clockin_data = thisweek_clockin_data[['小组长','本周工作人数']]
