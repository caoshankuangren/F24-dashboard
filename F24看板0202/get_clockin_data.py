...
def get_clockin_data(start_date,end_date):
    ...
    department_ids = {
        ...
        '绍栋dd':'od-3c414313f9327b7ff68687b70d49d844', #dd组
        ...
        '周嘉晖':'od-4b377c6c9254dad96e951b9be7570804', #Jeff
    ...
    worker_count_result['工作人数'] = worker_count_result['总名单'].apply(count_unique_names)
